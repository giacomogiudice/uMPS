...
%
% [A_left,A_right,S,eta] = canonical(A)
% This function generates the left and right canonical forms for A
% satisfying the usual canonical constraints. Additionally one has A_left*S
% = S*A_right and S diagonal, and corresponds to the Schmidt coefficients
% with normalization Tr(S^2) = 1. S^2 is also the right and left fixed
% points of A_left and A_right correspondingly. The dominant eigenvalue is
% eta.
...
[rho_right,~] = eigs(@(v) applyTv(v,A,1,A,'r'),D^2,1,'lm',opts);
