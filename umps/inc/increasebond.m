function [A_left_new,A_right_new,C_new,A_new,B_left_new,B_right_new] ...
    = increasebond(D_new,A_left,A_right,C,H,B_left,B_right)
% INCREASEBOND Optimally increase the bond dimension of the MPS tensors.
%
% [A_left_new,A_right_new,C_new,A_new,B_left_new,B_right_new] =
% increasebond(D_new,A_left,A_right,C,H,B_left,B_right)
% Increase the bond dimension of A_left, A_right, C, B_left, B_right by
...
if isequal(class(H),'TwoSiteOperator')
